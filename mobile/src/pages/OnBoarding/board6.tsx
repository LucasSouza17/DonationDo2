...
function OnBoarding6() {
    ...
    return (
        <ImageBackground source={require('../../assets/onboarding/onboarding.jpg')} style={styles.container}>
            <Image style={styles.board1} source={require("../../assets/onboarding/board6.png")} />
            <Text style={styles.title}>Passo 02</Text>
            <Text style={styles.description}>
            Após escolher um local, você será levado para uma tela com as informações de contato.
            </Text>
